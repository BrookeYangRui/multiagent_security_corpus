...
Set 1 uses `peer_reviewed == yes OR frozen_citation_count >= 10`. Set 2 contains the remaining in-scope emerging work. The current corpus is **91 Set 1 + 96 Set 2 = 189 works**.
