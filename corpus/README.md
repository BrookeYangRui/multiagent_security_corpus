...
| --- | ---: | --- |
| `set1_core.csv` | 104 | In-scope mature corpus: peer reviewed or at least 10 frozen citations. |
| `set2_emerging.csv` | 112 | In-scope emerging corpus that has not yet met the Set 1 maturity rule. |
| `set3_context.csv` | 452 | Contextual citations; not part of the MAS-security corpus. |
| `screened_out.csv` | 1,546 | Reviewed search records outside the active evidence sets. |
...
Ten Membership changes received named secondary confirmation from `expiol` on
2026-08-21; all other classifications remain model-assisted source review
records. The signoff does not upgrade source/evidence verification.
