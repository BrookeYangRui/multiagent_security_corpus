...
| --- | ---: | --- |
| `set1_core.csv` | 192 | In-scope mature corpus: peer reviewed or at least 10 frozen citations. |
| `set2_emerging.csv` | 263 | In-scope emerging corpus that has not yet met the Set 1 maturity rule. |
| `set3_context.csv` | 238 | Contextual citations; not part of the MAS-security corpus. |
| `screened_out.csv` | 1,524 | Reviewed search records outside the active evidence sets. |
