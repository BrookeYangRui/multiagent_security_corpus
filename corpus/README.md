# Authoritative 189 work corpus

Only Set 1 and Set 2 are active manuscript evidence sets.

| File | Count | Meaning |
| --- | ---: | --- |
| `set1_core.csv` | 92 | Mature in-scope MAS security work |
| `set2_emerging.csv` | 97 | Emerging in-scope MAS security work |
| **Union** | **189** | **Exact manuscript corpus** |
