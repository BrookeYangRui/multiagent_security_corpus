...
> **Final signed corpus status:** `set1_core` · `defense` · venue `IEEE IRI 2025` · signoff `2026-08-21`.
...
Primary URL: https://doi.org/10.1109/IRI66576.2025.00051

Open access URL: https://doi.org/10.1109/IRI66576.2025.00051

BibTeX key: supp_peerguard_defending_multi_agent_systems_against_backdoor_attacks_through_mutual_
...
Imported corpus characterization, pending author signoff: Agents mutually inspect peer reasoning to detect a backdoored member.
...
Imported corpus interpretation: Agents mutually inspect peer reasoning to detect a backdoored member.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | https://doi.org/10.1109/IRI66576.2025.00051 |
