...
> **Final signed corpus status:** `set1_core` · `defense` · venue `ICAART 2026` · signoff `2026-08-21`.
...
Primary URL: https://doi.org/10.5220/0014234400004052

Open access URL: https://doi.org/10.5220/0014234400004052

BibTeX key: supp_ai_agents_with_decentralized_identifiers_and_verifiable_credentials
...
Imported corpus characterization, pending author signoff: DIDs and verifiable credentials bind identities in agent-to-agent interactions.
...
Imported corpus interpretation: DIDs and verifiable credentials bind identities in agent-to-agent interactions.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | https://doi.org/10.5220/0014234400004052 |
