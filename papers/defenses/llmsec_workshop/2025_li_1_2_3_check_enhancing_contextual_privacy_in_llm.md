...
Venue: LLMSEC 2025 Workshop

DOI: 10.48550/arXiv.2508.07667

Primary URL: https://aclanthology.org/2025.llmsec-1.9/

Open access URL: https://aclanthology.org/2025.llmsec-1.9.pdf

BibTeX key: arxiv_2508_07667
...
Imported corpus characterization, pending author signoff: Confirmed by the recorded full-text interaction-security scope screen.
...
Imported corpus interpretation: Retained after the citation retrieval gate and security scope screen.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | ACL Anthology 2025.llmsec-1.9, pp. 115-128; later arXiv versions are merged into this canonical work. |

## Provenance

### Discovery Source

systematic search catalog and citation-threshold review
