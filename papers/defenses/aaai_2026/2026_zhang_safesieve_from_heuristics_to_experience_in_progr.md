...
Primary URL: https://ojs.aaai.org/index.php/AAAI/article/view/40236

Open access URL: https://ojs.aaai.org/index.php/AAAI/article/download/40236/44197

BibTeX key: supp_safesieve_from_heuristics_to_experience_in_progressive_pruning_for_llm_based_mul
...
Imported corpus characterization, pending author signoff: The defense prunes unsafe or unreliable inter-agent communication.
...
Imported corpus interpretation: The defense prunes unsafe or unreliable inter-agent communication.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | https://doi.org/10.1609/aaai.v40i35.40236 |
