...
Title: The Adaptive Interrogator: Detecting Trojan LLMs in Multi-Agent Systems via Evolved Conversational Strategies
...
Primary URL: https://aclanthology.org/2026.findings-acl.1348/

Open access URL: https://aclanthology.org/2026.findings-acl.1348/

BibTeX key: supp_the_adaptive_interrogator_detecting_trojan_llms_in_multi_agent_systems_via_evolv
...
Imported corpus characterization, pending author signoff: An interrogator agent uses interaction strategies to identify Trojan members.
...
Imported corpus interpretation: An interrogator agent uses interaction strategies to identify Trojan members.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | https://aclanthology.org/2026.findings-acl.1348/ |
