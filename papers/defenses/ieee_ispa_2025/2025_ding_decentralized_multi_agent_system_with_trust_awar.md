...
> **Final signed corpus status:** `set1_core` · `defense` · venue `IEEE ISPA 2025` · signoff `2026-08-21`.
...
Primary URL: https://doi.org/10.1109/ISPA67752.2025.00198

Open access URL: https://doi.org/10.1109/ISPA67752.2025.00198

BibTeX key: supp_decentralized_multi_agent_system_with_trust_aware_communication
...
Imported corpus characterization, pending author signoff: Trust scores govern communication among decentralized agents.
...
Imported corpus interpretation: Trust scores govern communication among decentralized agents.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | https://doi.org/10.1109/ISPA67752.2025.00198 |
