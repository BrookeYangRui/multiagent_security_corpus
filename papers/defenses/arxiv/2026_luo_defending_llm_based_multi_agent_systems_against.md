...
DOI: 10.48550/arXiv.2605.28104

Primary URL: https://arxiv.org/abs/2605.28104

Open access URL: https://arxiv.org/pdf/2605.28104

BibTeX key: supp_star_cooperative_attacks_2026
...
Imported corpus characterization, pending author signoff: Multiple malicious agents coordinate and adapt through multi-round communication; STAR evaluates and rectifies misleading sentences inside inter-agent messages.
...
Imported corpus interpretation: Direct cooperative malicious-member attack and communication-layer defense in LLM multi-agent systems.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | arXiv abstract and metadata; full-text method, denominator, and result-table locators require claim-level author signoff. |
