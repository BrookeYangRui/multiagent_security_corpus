...
Primary URL: https://aclanthology.org/2025.naacl-long.412/

Open access URL: https://aclanthology.org/2025.naacl-long.412/

BibTeX key: supp_teaching_models_to_balance_resisting_and_accepting_persuasion
...
Imported corpus characterization, pending author signoff: Adversarial persuasion and resistance are evaluated in recursive dialogues and multi-agent debate.
...
Imported corpus interpretation: Adversarial persuasion and resistance are evaluated in recursive dialogues and multi-agent debate.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | https://aclanthology.org/2025.naacl-long.412/ |
