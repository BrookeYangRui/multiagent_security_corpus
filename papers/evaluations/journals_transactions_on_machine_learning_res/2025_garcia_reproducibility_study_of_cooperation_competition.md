...
Primary URL: https://openreview.net/forum?id=MTrhFmkC45

Open access URL: https://openreview.net/forum?id=MTrhFmkC45

BibTeX key: supp_reproducibility_study_of_cooperation_competition_and_maliciousness_llm_stakehold
...
Imported corpus characterization, pending author signoff: The study reproduces maliciousness, information leakage, and fairness effects in interacting LLM stakeholders.
...
Imported corpus interpretation: The study reproduces maliciousness, information leakage, and fairness effects in interacting LLM stakeholders.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | https://openreview.net/forum?id=MTrhFmkC45 |
