...
Primary URL: https://doi.org/10.5220/0014840300004015

Open access URL: https://arxiv.org/pdf/2603.18096

BibTeX key: supp_a_trace_based_assurance_framework_for_agentic_ai_orchestration_contracts_testing
...
Imported corpus characterization, pending author signoff: Assurance contracts and traces cover orchestrated agent workflows.
...
Imported corpus interpretation: Assurance contracts and traces cover orchestrated agent workflows.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | ENASE 2026 proceedings, pp. 420-427; DOI 10.5220/0014840300004015. |
