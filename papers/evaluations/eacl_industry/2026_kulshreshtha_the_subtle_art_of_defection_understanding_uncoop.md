...
> **Final signed corpus status:** `set1_core` · `evaluation` · venue `EACL 2026 Industry Track` · signoff `2026-08-21`.
...
DOI: 10.18653/v1/2026.eacl-industry.44

Primary URL: https://aclanthology.org/2026.eacl-industry.44/

Open access URL: https://aclanthology.org/2026.eacl-industry.44.pdf

BibTeX key: supp_the_subtle_art_of_defection_understanding_uncooperative_behaviors_in_llm_based_m
...
Imported corpus characterization, pending author signoff: Defection is defined through strategic behavior among interacting agents.
...
Imported corpus interpretation: Defection is defined through strategic behavior among interacting agents.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | EACL 2026 Industry Track, pp. 571-585, Anthology ID 2026.eacl-industry.44. |
