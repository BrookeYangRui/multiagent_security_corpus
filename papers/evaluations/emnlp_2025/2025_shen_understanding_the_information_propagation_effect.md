...
Primary URL: https://aclanthology.org/2025.emnlp-main.623/

Open access URL: https://aclanthology.org/2025.emnlp-main.623/

BibTeX key: supp_understanding_the_information_propagation_effects_of_communication_topologies_in
...
Imported corpus characterization, pending author signoff: The measured effect is information propagation under different communication graphs.
...
Imported corpus interpretation: The measured effect is information propagation under different communication graphs.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | https://aclanthology.org/2025.emnlp-main.623/ |
