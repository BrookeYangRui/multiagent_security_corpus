...
Venue: arXiv:2512.08290

DOI: Not reported

Primary URL: https://arxiv.org/abs/2512.08290

Open access URL: https://arxiv.org/abs/2512.08290

BibTeX key: mcp_sok_2025
...
Imported corpus characterization, pending author signoff: MCP security and safety taxonomy with implications for distributed tool delegation and multi-agent environments.
...
Imported corpus interpretation: Important protocol and infrastructure comparator, but MCP often connects one host agent to tools and is broader than strict multi-agent interaction.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | Primary preprint full text |
