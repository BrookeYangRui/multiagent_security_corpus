...
> **Final signed corpus status:** `set2_emerging` · `survey` · venue `arXiv / preprint` · signoff `2026-08-21`.
...
Venue: arXiv:2604.23338

DOI: Not reported

Primary URL: https://arxiv.org/abs/2604.23338

Open access URL: https://arxiv.org/abs/2604.23338

BibTeX key: chu2026layered
...
Imported corpus characterization, pending author signoff: Uses a seven-layer agentic attack-surface model with multi-agent coordination as one layer.
...
Imported corpus interpretation: Auditable broad agent-security survey and coverage analysis, but not MAS-first.
