...
Imported corpus characterization, pending author signoff: MAS appears within a broader component-centered agent threat landscape
...
Imported corpus interpretation: Primary boundary is general AI agents and four knowledge gaps, not LLM-MAS interaction as the sole object.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | ACM CSUR abstract and taxonomy sections, 36-page article |
