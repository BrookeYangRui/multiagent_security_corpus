...
Primary URL: https://aclanthology.org/2025.realm-1.13/

Open access URL: https://aclanthology.org/2025.realm-1.13/

BibTeX key: supp_safe_in_isolation_dangerous_together_agent_driven_multi_turn_decomposition_jailb
...
Imported corpus characterization, pending author signoff: A team of agents decomposes a harmful request into individually benign-looking turns.
...
Imported corpus interpretation: A team of agents decomposes a harmful request into individually benign-looking turns.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | https://aclanthology.org/2025.realm-1.13/ |
