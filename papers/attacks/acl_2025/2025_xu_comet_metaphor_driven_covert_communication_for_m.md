...
Primary URL: https://aclanthology.org/2025.acl-long.389/

Open access URL: https://aclanthology.org/2025.acl-long.389/

BibTeX key: supp_comet_metaphor_driven_covert_communication_for_multi_agent_language_games
...
Imported corpus characterization, pending author signoff: Multiple agents establish covert communication through metaphor in language games.
...
Imported corpus interpretation: Multiple agents establish covert communication through metaphor in language games.
...
| ----- | ------------ | ----------- | ------- | ---: | --------------- | -------- |
| Imported scope and placement | Corpus interpretation | Paper | Unclear | | | https://aclanthology.org/2025.acl-long.389/ |
